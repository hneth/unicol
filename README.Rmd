...
# Stats (for n <- N):
n_pals  # number of color palettes: 277 on 2026-01-16. 
n_inst  # number of institutions:   117 on 2026-01-16.
# Colors (in current set):
col_count
length(unlist(pal_list))          # number of colors: 101 on 2026-01-15. 
length(unique(unlist(pal_list)))  # number of unique colors: 90 on 2026-01-15 
```
...
* By **[Hansjörg Neth](https://neth.de/)** (<h.neth@uni.kn>, [SPDS](https://spds.uni-konstanz.de/), [University of Konstanz](https://www.uni-konstanz.de/en/))
