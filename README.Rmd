...
# unicol `r packageVersion('unicol')` <img src = "./inst/pix/pkg_unicol_s.png" align = "right" alt = "unicol::" width = "180px" />
...
This package is based on the R\ package **[unikn](`r url_unikn_cran`)** and loads key functionality from it. 
