...
This vignettes shows **how to** use the color palettes included in the **unicol** package. 
(See the vignette on [Color palettes](color_pals.html) for an overview of the palettes included in the **unicol** R package.) 
...
```{r plot-par-set, eval = FALSE, echo = FALSE}
...
```{r demo-scatterplot, eval = FALSE, fig.width = 5, fig.asp=.95, fig.align = 'center', collapse = TRUE}
...
```{r plot-par-reset, eval = FALSE, echo = FALSE}
