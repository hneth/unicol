...
The **unicol** package currently contains **`r length(unique(unicol_data$pal))`\ color palettes** from **`r length(unique(unicol_data$inst))`\ institutions**. 
...
```{r unicol-pals-table, echo = FALSE}
my_caption <- paste0("A sample of ", n, " unicol palettes.")

knitr::kable(unicol_data[sample_n, ], caption = my_caption)
```

Figure\ 1 illustrates `r n` random color palettes: 

```{r unicol-pals-figure, echo = FALSE, eval = TRUE, fig.width = 7.2, out.width = "600px", fig.asp = 2.0, fig.cap = "A set of color palettes in the unicol package."}
# Figure:
my_title <- paste0("A sample of ", n, " unicol palettes")
...
```{r show-add-pals, eval = FALSE, fig.width = 7.2, out.width = "550px", fig.asp = 2.0}
...
```{r def-col-mpg-example, eval = FALSE, fig.width = 5, fig.asp = 1, fig.align = 'center'}
...
```{r def-col-rgb-hex-equal, eval = FALSE}
...
```{r newpal-mpg-3, eval = FALSE, fig.width = 5, fig.asp = 1, fig.align = 'center'}
...
```{r seecol-mpg-3, eval = FALSE, fig.width = 5, fig.asp = 1, fig.align = 'center'}
seecol(mpg_pal_3, 
...
```{r seecol-mpg-5, eval = FALSE, fig.width = 5, fig.asp = 1, fig.align = 'center'}
...
```{r compare-custom-pals, eval = FALSE, fig.width = 5, fig.asp = .55, fig.align = 'center', collapse = TRUE}
