...
```{r unicol-pals-table-links, echo = FALSE}
# 1. Utility functions: ------

# lookup: Look-up / filtering operations within a df: ----
#         (A generalization of get_fns in 5_util.R.)
...
link_github_doc <- function(pal){
  ...
  ref_url <- paste0(url_github_doc_dev, "reference/")  # reference of dev version
