...
The **unicol** package currently provides **224 color palettes** from
**95 institutions**.
...
<!-- The **unicol** package currently contains **224\ color palettes** from **95\ institutions**.  -->
<!-- Example 1: Random pals (from vignette color_pals.Rmd): -->
<!-- Show as a table: -->
<!-- Show as a figure: -->

**Figure 1** illustrates 50 random color palettes (with 264 colors):

<div class="figure" style="text-align: center">

<img src="man/figures/README-unicol-pals-example-1-figure-1.png" alt="Figure 1: A sample of 50 unicol palettes (containing 264 colors)." width="600px" />
<p class="caption">
Figure 1: A sample of 50 unicol palettes (containing 264 colors).
</p>
...
\[File `README.Rmd` updated on 2023-09-06.\]
