...
# unicol 0.1.0.9006 <img src = "man/figures/logo.png" align = "right" alt = "unicol::" width = "165px" alt="" />
...
The **unicol** package currently provides **211 color palettes** from
**91 institutions**.
...
<!-- The **unicol** package currently contains **211\ color palettes** from **91\ institutions**.  -->
...
<img src="man/figures/README-unicol-pals-example-1-figure-1.png" alt="Figure 1: A sample of 50 unicol palettes (containing 235 colors)." width="90%" />
<p class="caption">
...
\[File `README.Rmd` updated on 2023-08-29.\]
