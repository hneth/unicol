...
# unicol 0.1.0.9009 <img src = "man/figures/logo.png" align = "right" alt = "unicol::" width = "165px" alt="" />
...
The **unicol** package currently provides **222 color palettes** from
**94 institutions**.
...
<!-- The **unicol** package currently contains **222\ color palettes** from **94\ institutions**.  -->
<!-- Example 1: Random pals (from vignette color_pals.Rmd): -->
<!-- Show as a table: -->
<!-- Show as a figure: -->

**Figure 1** illustrates 50 random color palettes (with 262 colors):

<div class="figure" style="text-align: center">

<img src="man/figures/README-unicol-pals-example-1-figure-1.png" alt="Figure 1: A sample of 50 unicol palettes (containing 262 colors)." width="600px" />
<p class="caption">
Figure 1: A sample of 50 unicol palettes (containing 262 colors).
</p>
