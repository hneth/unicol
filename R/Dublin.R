...
# - pal_trinity_1: Primary color ----

#'Colors of the Trinity College Dublin:
#'
...
#'\href{https://www.tcd.ie/identity/colour-palette/}.
#'
#'@examples
#'pal_trinity_1
...
pal_trinity_1 <- unikn::newpal(col = c("#0569b9", "#448fcb","#82b4dc", "#cidaee", "#e6f0f8", "#50555a", "#7c8083", "#a8aaad", "#d3d5d6", "#eeeeef", "#ffffff", "#000000"), names = c("trinity_blue_100", "trinity_blue_75", "trinity_blue_50", "trinity_blue_25", "trinity_blue_10", "grey_100", "grey_75", "grey_50", "grey_25", "grey_10", "white", "black"), as_df = FALSE)
...
#' 
#' @export
pal_trinity_2 <- unikn::newpal(col = c("#12312b", "#0D1E1C", "#ffffff", "000000", "#f7f7f7", "#e2e2e2", "#707070", "#424141"), names = c("forest_green", "rich_forest_green","snow_white", "midnight_black", "web_gray_1", "web_gray_2", "web_gray_3", "granite_gray"), as_df = FALSE)
