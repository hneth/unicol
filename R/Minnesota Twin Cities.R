...
#' \href{https://university-relations.umn.edu/resources/colors-and-type}{UMN's website}.
#'
#' @examples
...
pal_minnesotatwin_primary <- unikn::newpal(col = c("#7A0019","#FFCC33"), 
...
pal_minnesotatwin_secondary <- unikn::newpal(col = c("#5B0013","#FFB71E","#333333", "#777677",
