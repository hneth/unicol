...
#'Colors of the University of Kassel:
#'
#'\code{pal_kassel_haus} provides the 8 primary colors
...
#'\code{"light_green"}(defined as HEX #4AAC96)
#'\code{"dark_gold"}(defined as HEX #EAC372)
#'
#'\code{pal_kassel_haus} uses the HEX color definition.
#'
#'@return
...
#'\href{https://www.uni-kassel.de/hochschulverwaltung/themen/toolbox/corporate-design-und-medienservice/gestaltungselemente}.
#'
#'@examples
#'pal_kassel_haus
...
pal_kassel_haus <- unikn::newpal(col = c("#575757", "#9D9D9D", "#DADADA", "#9A0C46", "#C7105C", "#F3D8DD", "#153824", "#5095C8", "#C4D20F", "#4AAC96", "#EAC372"), names = c("k80", "k50", "k20", "hks28+k30", "hks28", "hks28-20", "dark_green", "light_blue", "yellow_green", "light_green", "dark_gold"), as_df = FALSE)
