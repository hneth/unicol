...
#' colours of the Manchester University
#'
...
#' \href{https://www.manchester.edu/about-manchester/office-directory/marketing/brand-toolkit/color-palette#:~:text=Manchester%20gold%2C%20black%2C%20and%20gray%20are%20our%20primary%20brand%20colors.}{ (website)}.
#'
#' @examples
#' manchester_uni_1
#' unikn::seecol(manchester_uni_1, main = "Manchester University") 
#' # view color palette
#'
...
#unikn::seecol(manchester_uni_accent, main = "Primary colours of the Manchester University", col_bg = "lightgray")
