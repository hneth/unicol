...
pal_glasgow_2 <- unikn::newpal(rgb(0, 181, 209, maxColorValue = 255), rgb(176, 108, 150, maxColorValue = 255), rgb(255, 185, 72, maxColorValue = 255), rgb(255, 220, 54, maxColorValue = 255), rgb(170, 128, 102, maxColorValue = 255), names = c("glasgow_turquoise", "glasgow_rose",
                                                                                                                                                                                                                                                  "glasgow_pumpkin", "glasgow_sunshine","glasgow_mocha"), as_df = FALSE)
##Check:
