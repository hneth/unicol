...
pal_glasgow_1 <- unikn::newpal(col = c("#003865", "#7D2239", "#005C8A", "#5B4D94", "#006630", "#385A4F",
                               ...
                               names = c("glasgow_university_blue", "glasgow_burgundy", "glasgow_cobalt", "glasgow_lavender", "glasgow_leaf", "glasgow_moss",
                                         "glasgow_pillarbox", "glasgow_rust", "glasgow_sandstone", "glasgow_sky_blue", "glasgow_slate", "glasgow_thistle"), 
                               as_df = FALSE)
