...
pal_glasgow_1 <- unikn::newpal(col = c("#003865", "#7D2239", "#005C8A", "#5B4D94",
                                       "#006630", "#385A4F", "#B30C00", "#9A3A06",
                                       "#52473B", "#005398", "#4F5961", "#951272"), 
                               names = c("glasgow_university_blue", "glasgow_burgundy", "glasgow_cobalt", "glasgow_lavender",
                                         "glasgow_leaf", "glasgow_moss", "glasgow_pillarbox", "glasgow_rust", 
                                         "glasgow_sandstone","glasgow_sky_blue", "glasgow_slate","glasgow_thistle"), 
                               as_df = FALSE)


# - pal_glasgow_2: Secondary colors ------ 

#' Secondary colors of the University of Glasgow
#'
...
#' @examples
#' pal_glasgow_2
#' unikn::seecol(pal_glasgow_2, main = "University of Glasgow") # view color palette
#'
...
pal_glasgow_2 <- unikn::newpal(col = c(rgb(  0, 181, 209, maxColorValue = 255), 
                               ...
                               names = c("glasgow_turquoise", "glasgow_rose", 
                                         "glasgow_pumpkin", "glasgow_sunshine","glasgow_mocha"), 
                               as_df = FALSE)
