...
# - UCSD_1_core: Core colors of UC San Diego ------
...
#'
#' \code{UCSD_1_core} uses the HEX color definitions. 
#'
#' @return
...
#' 
#' \code{UCSD_2_accent} uses the HEX color definitions. 
#'
#' @return
#' A named vector of colors (HEX/HTML codes of type character).
#'
...
#'
#' \code{UCSD_3_neutral} uses the HEX color definitions. 
#'
#' @return
#' A named vector of colors (HEX/HTML codes of type character).
#'
...
UCSD_3_neutral <- unikn::newpal(col = c("#000000", "#747678", "#B6B1A9", "#FFFFFF"),
