...
# unipals: "pal_uci_1", "pal_uci_secondary", "pal_ucihealth_2", "pal_ucihealth_3" (4)
...
# - pal_uci_1: Primary colors ----

#' Primary colors of the University of California, Irvine 
#'
#' \code{pal_uci_1} provides the 2 primary colors
...
#' @examples
#' pal_uci_1
#' unikn::seecol(pal_uci_1, main= "University of California, Irvine") #view color palette.
#'
...
pal_uci_1 <- unikn::newpal(col = c("#0064a4", "#ffd200"), 
...
#' Secondary colors of the University of California, Irvine
#' 
...
pal_uci_secondary <- unikn::newpal(col = c("#6aa2b8", "#c6beb5", "#1b3d6d", "#f78d2d", 
...
# - pal_ucihealth_2: Neutral colors ----

#' Neutral colors of the University of California, Irvine
#' 
#' \code{pal_ucihealth_2} provides the 5 secondary health colors
...
#' @examples 
#' pal_ucihealth_2
#' unikn::seecol(pal_ucihealth_2, main = "University of California, Irvine") # view color palette
#' 
#' @seealso 
#' \code{\link{seecol}} for viewing and comparing color palettes;
#' \code{\link{usecol}} for using color palettes;
...
pal_ucihealth_2 <- unikn::newpal(col = c("#981e32","#631d76","#0083b3","#3f9c35","#1b3d6d"), 
                                 names = c("brick_red","purple","teal_blue", "green", "dark_blue"), 
                                 as_df = FALSE)



# - pal_ucihealth_3: Tertiary colors ----

#' Tertiary colors of the University of California, Irvine
#' 
#' \code{pal_ucihealth_3} provides the 5 teritary colors of the 
#' of the \href{https://www.uci.edu}{University of California Health, Irvine}, USA.
#'
...
#' @examples 
#' pal_ucihealth_3
#' unikn::seecol(pal_ucihealth_3, main = "University of California, Irvine") # view color palette
#' 
#' @seealso 
#' \code{\link{seecol}} for viewing and comparing color palettes;
#' \code{\link{usecol}} for using color palettes;
...
pal_ucihealth_3 <- unikn::newpal(col = c("#b71234","#7c109a","#00b0ca","#7ab800","#fecb00"), 
