...
# 
# # On 2023-09-10:
# length(all_data$pal)           #  232 color palettes
# length(unique(all_data$inst))  #  100 institutions
# sum(n_cols)                    # 1562 colors
