...
# - york_1: Primary colors ------

#' Primary colors of the York University, Canada  
#'
#' \code{york_1} provides the three primary colors 
...
#' 
#' \code{york_1} uses the HEX color definitions. 
#'
#' @return 
...
#' @examples
#' york_1
#' unikn::seecol(york_1, main = "Primary colors of York University") # view color palette
#'
...
york_1 <- unikn::newpal(col = c("#E31837", "#FFFFFF", "#000000"),
                        names = c("york_red", "white", "black"),
                        as_df = FALSE)

# - york_2: secondary colors ------

#' Secondary colors of the York University, Canada  
#'
#' \code{york_2} provides the five secondary colors 
#' of the \href{https://www.yorku.ca/}{York University}, Canada.
#'
#'
...
#' 
#' \code{york_2} uses the HEX color definitions. 
#' 
#' @return 
#' A named vector of colors (HEX/HTML codes of type character).
#'
...
#' @examples
#' york_2
#' unikn::seecol(york_2, main = "York University 2") # view color palette
#'
#' @family university color palettes
#'
#' @seealso
...
york_2 <- unikn::newpal(col = c("#AF0D1A", "#810001", "#3AC2EF", "#ACE6F8", 
...
# # Check: 
# unikn::seecol(york_1, main = "Primary colors of the York University", col_bg = "lightgrey")
# unikn::seecol(york_2, main = "Secondary colors of the York University", col_bg = "white")
