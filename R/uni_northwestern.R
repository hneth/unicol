## uni_northwestern.R | 2023 06 14
## Colors of Northwestern University, USA
## -----------------------------------------------

# Information: ------

# uni_pals: "uni_northwestern_primary_1", "uni_northwestern_secondary_2" (2)
...
# - uni_northwestern_primary_1: Primary colors ------

#' Primary colors of Northwestern University
#'
#' \code{uni_northwestern_primary_1} provides the 20 primary colors
...
#'
#' @examples
#' uni_northwestern_primary_1
#' unikn::seecol(uni_northwestern_primary_1, main = "Primary colors NW") # view color palette
#'
#' @family university color palettes
#'
#' @seealso
#' \code{\link{uni_northwestern_secondary_2}} for secondary, secondary colors of Northwestern University
...
# # Check:
# unikn::seecol(uni_northwestern_primary_1, main = "Primary colors Northwestern University", col_bg = "white")



# - uni_northwestern_secondary_2: Secondary colors ------

#' Secondary colors of Northwestern University
#'
#' \code{uni_northwestern_secondary_2} provides the 12 secondary colors
#' of the \href{https://www.northwestern.edu}{Northwestern University}, USA.
#'
...
#'
#' @examples
#' uni_northwestern_secondary_2
#' unikn::seecol(uni_northwestern_secondary_2, main = "Secondary colors NW") # view color palette
#'
#' @family university color palettes
#'
#' @seealso
#' \code{\link{uni_northwestern_primary_1}} for primary colors of Northwestern University
#' \code{\link{seecol}} for viewing and comparing color palettes;
#' \code{\link{usecol}} for using color palettes;
#' \code{\link{simcol}} for finding similar colors;
#' \code{\link{newpal}} for defining new color palettes;
...
uni_northwestern_secondary_2 <- unikn::newpal(col = c("#58B947", "#7FCECD", "#5091CD", "#EDE93B", "#FFC520", "#EF553F", "#008656", "#007FA4", "#0D2D6C", "#D9C826", "#CA7C1B", "#D85820"),
...
# # Check:
# unikn::seecol(uni_northwestern_secondary_2, main = "Secondary colors Northwestern University", col_bg = "lightgrey")
