...
`mcgill_red` provides the primary color "McGill Red" (or `mcgill_red`)
of [McGill University](https://www.mcgill.ca), Canada.
...
Colour definitions are based on [McGill](https://www.mcgill.ca)'s
[visual identity
guide](https://www.mcgill.ca/visual-identity/visual-identity-guide).
...
The primary colour is called `"McGill red"` and defined as CMYK
0/100/90/0, RGB 237/27/47, HEX \#ed1b2f.
