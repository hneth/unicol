...
`uni_magdeburg_3` provides medical faculty and hospital colors of the
[Otto von Guericke University Magdeburg](https://www.ovgu.de/) (OVGU),
Germany.
...
Color definitions are based on the [OVGU](https://www.ovgu.de/)'s
[Corporate
design](https://www.cd.ovgu.de/Logo_+Farbe_+Schrift/Farbe.html)
guidelines (HTML).
...
The 3 primary colors `Dunkelblau`, `Schwarz`, and `Weiss` are key
elements of the visual design identity of the medical faculty and
university hospital Magdeburg.

Together, the colors provide a serious and progressive impression,
corresponding to the corporate vision of the institution. The triad
forms part of the logo and other design elements.

`uni_magdeburg_3` is based on RGB color definition.

While the primary colors are obligatory in every publication, they can
be supported by 7 secondary colors. These bright and friendly colors
provide emphasis, structure, and visual distinctions when balanced with
the darker and more rational primary colors.
...
for primary colors of the OVGU Magdeburg;
[`uni_magdeburg_2`](https://hneth.github.io/unicol/dev/reference/uni_magdeburg_2.md)
for faculty colors of the OVGU Magdeburg;
...
``` r
uni_magdeburg_3
#> Dunkelblau      Weiss    Schwarz    Flieder    Tuerkis      Gruen    Apricot 
#>  "#002d5c"    "white"    "black"  "#9698cc"  "#a5ced8"  "#84c597"  "#e8817a" 
#>       Rosa       Gold       Grau 
#>  "#e3a8c4"  "#caa371"  "#777877" 
