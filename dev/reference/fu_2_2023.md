...
`fu_2_2023` provides the three accent colors and seven grey colors of
the [Free University Berlin](https://www.fu-berlin.de/en/index.html),
Germany.
...
The three accent colors support the two primary colors of
...
``` r
fu_2_2023
#> FU accent orange    FU accent red   FU accent blue        FU grey 1 
#>        "#FF9900"        "#CC0000"        "#0066CC"        "#333333" 
#>        FU grey 2        FU grey 3        FU grey 4        FU grey 5 
#>        "#666666"        "#999999"        "#CCCCCC"        "#DDDDDD" 
#>        FU grey 6        FU grey 7 
#>        "#EEEEEE"        "#F1F1F1" 
