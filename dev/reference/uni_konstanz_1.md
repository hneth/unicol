...
`uni_konstanz_1` provides the default color palette of the [University
of Konstanz](https://www.uni-konstanz.de), Germany.
...
R package **unikn**, retrieved from
<https://CRAN.R-project.org/package=unikn>, doi
[doi:10.5281/zenodo.7096191](https://doi.org/10.5281/zenodo.7096191) .

Original color definitions are based on
[uni.kn](https://www.uni-konstanz.de)'s [Corporate
design](https://www.uni-konstanz.de/universitaet/aktuelles-und-medien/online-und-print-medien-gestalten/corporate-design/)
and [Colours for complex
...
The R package **unikn** (at <https://CRAN.R-project.org/package=unikn>)
provides many additional color palettes for the [University of
Konstanz](https://www.uni-konstanz.de).

## See also

[`uni_konstanz_2`](https://hneth.github.io/unicol/dev/reference/uni_konstanz_2.md)
for the preferred colors of the University of Konstanz;
