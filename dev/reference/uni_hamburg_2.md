...
`uni_hamburg_2` provides three primary colors of the [University of
Hamburg](https://www.uni-hamburg.de), Germany, in combination with two
pair-wise variants of them.
...
Color definitions are based on the [CD
manual](https://www.fiona.uni-hamburg.de/beantragung/regelungen.html).
...
for primary colors of the University of Hamburg;
