...
`fu_1_2023` provides a gradient of the two primary colors of the [Free
University Berlin](https://www.fu-berlin.de/en/index.html), Germany.
...
for the two primary colors and the
[`ac`](https://rdrr.io/pkg/unikn/man/ac.html) or
[`usecol`](https://rdrr.io/pkg/unikn/man/usecol.html) functions for
creating alternative color gradients.
