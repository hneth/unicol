...
`uni_goettingen_1` provides the primary blue colors of the [University
of Göttingen](https://www.uni-goettingen.de/), Germany.
...
The primary dark blue color `uniblau` is defined as `Uni-Blau HKS 41`.
The palette `uni_goettingen_1` adds some derived colors, while the
palette
[`uni_goettingen_2`](https://hneth.github.io/unicol/dev/reference/uni_goettingen_2.md)
provides secondary colors.
