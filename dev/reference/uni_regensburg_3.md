...
`uni_regensburg_3` provides the departmental (faculty) colors for web
fonts at the [University of Regensburg](https://www.uni-regensburg.de),
Germany.
...
Named colors of `uni_regensburg_3` correspond to the following UR
faculties:
...
4.  `orangerot`: Philosophie, Kunst-, Geschichts- und
...
Note that the font color glutrot is currently identical to the area
color of
...
and
[`uni_regensburg_2`](https://hneth.github.io/unicol/dev/reference/uni_regensburg_2.md)
for alternative colors of the University of Regensburg;
...
``` r
uni_regensburg_3
#>           urangelb laerchennadelgruen        vatikangelb          orangerot 
#>          "#A4A90C"          "#8B8600"          "#BD9600"          "#BD4E00" 
#>        heucherarot     heidenelkenrot         blattgruen       tuerkisgruen 
#>          "#990022"          "#7D003C"          "#3F9300"          "#007C5F" 
#>       eisvogelblau       spektralblau          capriblau            glutrot 
#>          "#006E76"          "#006C8E"          "#004455"          "#DA3C43" 
