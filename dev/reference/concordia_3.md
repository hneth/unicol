...
`concordia_3` provides the nine background tints of [Concordia
University](https://www.concordia.ca), Canada.
...
Color definitions are based on [Concordia](https://www.concordia.ca)'s
[web colour
palette](https://www.concordia.ca/web/design/ui-kit-style-guide-accessibility/web-palette-new.html).
...
The 9 background tints are `"Burgundy 1"` (defined as HEX \#E9D3D7),
`"Magenta 1"` (defined as HEX \#FACDE3), `"Orange 1"` (defined as HEX
\#f9cdc3), `"Mauve 1"` (defined as HEX \#dcd6e8), `"Dark blue 1"`
(defined as HEX \#B2C5DA), `"Blue 1"` (defined as HEX \#d3e1e9),
`"Turquoise 1"` (defined as HEX \#CCE3E4), `"Green 1"` (defined as HEX
\#dfeccf), and `"Gold 1"` (defined as HEX \#e9e3d3).

`concordia_3` uses the HEX color definitions.

The background tint colours of `concordia_3` can be used to create
blocks of background colour on a web page to separate and draw attention
to content.
...
``` r
concordia_3
#>  Burgundy 1   Magenta 1    Orange 1     Mauve 1 Dark blue 1      Blue 1 
#>   "#E9D3D7"   "#FACDE3"   "#f9cdc3"   "#dcd6e8"   "#B2C5DA"   "#d3e1e9" 
#> Turquoise 1     Green 1      Gold 1 
#>   "#CCE3E4"   "#dfeccf"   "#e9e3d3" 
