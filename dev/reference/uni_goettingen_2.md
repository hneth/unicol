...
`uni_goettingen_2` provides the secondary colors of the [University of
Göttingen](https://www.uni-goettingen.de/), Germany.
...
These colors are to be combined with the blue primary colors provided by
palette
[`uni_goettingen_1`](https://hneth.github.io/unicol/dev/reference/uni_goettingen_1.md).

`uni_goettingen_2` corrects an error in the color definitions of
<https://www.uni-goettingen.de/de/589412.html>, where `"Chamois"` and
`"Altweiss"` had identical, but non-corresponding RGB and HEX values.
...
for alternative colors of the University of Goettingen;
...
``` r
uni_goettingen_2
#>   schwarz     weiss   chamois  altweiss  grau 90%  grau 80%  grau 60%  grau 20% 
#>   "black"   "white" "#eae2d8" "#f2f0e8" "#3b3b3a" "#575656" "#878786" "#d9dada" 
