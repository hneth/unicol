...
`uni_jena_1` provides the main `dunkelblau` color and the auxiliary
`gold` color of the [University of Jena](https://www.uni-jena.de),
Germany.
...
<https://www.uni-jena.de/163691/corporate-design>.
...
The main color `dunkelblau` is alternatively defined as `RGB 0/47/93`,
`CMYK 100/70/10/50`, or `HKS 41 K`.

The auxiliary color `gold` is alternatively defined as `RGB 174/154/99`,
`CMYK 20/25/60/25`, or `HKS 98 K`.

See the [`ac`](https://rdrr.io/pkg/unikn/man/ac.html) and
[`usecol`](https://rdrr.io/pkg/unikn/man/usecol.html) functions for
creating color gradients.

The full name of the [University of Jena](https://www.uni-jena.de) is
Friedrich-Schiller-Universität Jena.

## See also

[`uni_jena_2`](https://hneth.github.io/unicol/dev/reference/uni_jena_2.md)
for departmental colors of the University of Jena;
