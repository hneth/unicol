...
`concordia_4` provides the five neutral colours of [Concordia
...
The 5 neutral colours are `"Light grey"` (defined as HEX \#f0f0f0),
`"Medium grey"` (defined as HEX \#c8c8c8), `"Dark grey"` (defined as HEX
\#6e6e6e), `"Very dark grey"` (defined as HEX \#2c2c2c), and `"black"`
