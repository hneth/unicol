...
`fu_4` provides four additional colors of the [Free University
Berlin](https://www.fu-berlin.de/en/index.html), Germany.
...
[FU](https://www.fu-berlin.de/en/index.html)'s
[CI](https://www.fu-berlin.de/sites/corporate-design/) page.
...
[`fu_1`](https://hneth.github.io/unicol/dev/reference/fu_1.md) for the
two primary colors of the FU Berlin;
[`fu_2`](https://hneth.github.io/unicol/dev/reference/fu_2.md) for the
black color gradient of the FU Berlin;
[`fu_3`](https://hneth.github.io/unicol/dev/reference/fu_3.md) for the
blue color gradient of the FU Berlin;
[`fu_0_2023`](https://hneth.github.io/unicol/dev/reference/fu_0_2023.md)
for older colors of the FU Berlin (pre 2024);
[`fu_1_2023`](https://hneth.github.io/unicol/dev/reference/fu_1_2023.md)
for older color gradient of the FU Berlin (pre 2024);
