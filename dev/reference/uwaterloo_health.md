...
`uwaterloo_health` provides the four teal color levels of the
...
Use the color Teal to identify content and communications from the
Faculty of Health.

The 4 teal colors are `"Teal Level 1"` (defined as CMYK: 30 0 6 0, RGB:
151 223 239, HEX: \#97DFEF), `"Teal Level 2"` (defined as CMYK: 69 0 16
0, RGB: 0 190 208, HEX: \#00BED0), `"Teal Level 3"` (print primary
color) (defined as CMYK: 100 0 30 2, RGB: 0 152 165, HEX: \#0098A5), and
`"Teal Level 4"` (digital primary color) (defined as CMYK: 83 14 23 50,
RGB: 0 89 99, HEX: \#005963).
