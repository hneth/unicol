...
`carleton` provides the two official colors of the [University of
Carleton](https://carleton.ca/), Canada.
...
Color definitions are based on the [University of Carleton's
website](https://www.carleton.edu/communications/resources/college-wordmark-identity-graphics/college-colors/).
...
The 2 official colors are `maize` (defined as Pantone 122, and
approximated by RGB 255/223/79, or HEX \#FFDF4F), and `Carleton blue`
(defined as Pantone 294, and approximated by RGB 0/48/105, or HEX
\#003069).
