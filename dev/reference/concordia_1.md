...
`concordia_1` provides the eight primary colours of [Concordia
...
The 8 primary colours are `"Burgundy"` (defined as HEX \#912338),
`"Magenta"` (defined as HEX \#db0272), `"Orange"` (defined as HEX
\#da3a16), `"Mauve"` (defined as HEX \#573996), `"Dark"` (defined as HEX
\#004085), `"Blue"` (defined as HEX \#0072a8), `"Turquoise"` (defined as
HEX \#057d78), and `"Grenn"` (defined as HEX \#508212).
...
for background tints of Concordia University;
...
``` r
concordia_1
#>  Burgundy   Magenta    Orange     Mauve Dark blue      Blue Turquoise     Grenn 
#> "#912338" "#db0272" "#da3a16" "#573996" "#004085" "#0072a8" "#057d78" "#508212" 
