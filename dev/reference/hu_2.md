...
`hu_2` provides the eight secondary colors of the [Humboldt University
Berlin](https://www.hu-berlin.de/en), Germany, updated in 2023.
...
Color definitions are based on HU's [Corporate Design
guide](https://www.hu-berlin.de/de/service/design/basiselemente/farbe).
...
The secondary colors provide 5 variants of the primary colors of
[`hu_1`](https://hneth.github.io/unicol/dev/reference/hu_1.md) and 3
background colors. See `hu_2` and HU's [Corporate Design
guide](https://www.hu-berlin.de/de/service/design/basiselemente/farbe).
...
[`hu_1`](https://hneth.github.io/unicol/dev/reference/hu_1.md) for
primary colors of the HU Berlin;
...
for possible accent colors of the HU Berlin;
...
``` r
hu_2
#>      HU blau II     HU blau III      HU blau IV   HU schwarz II  HU schwarz III 
#>       "#004c90"       "#5b89b0"       "#d7dde1"       "#74747e"       "#cfcfd1" 
