...
`fu_1` provides the two primary colors of the [Free University
...
[`fu_4`](https://hneth.github.io/unicol/dev/reference/fu_4.md) for the
additional colors of the FU Berlin;
