...
`ucalgary_2` provides the four secondary colours of the [University of
...
The secondary colours are `"light_orange"` (defined as HEX \#ffa300),
`"dark_orange"` (defined as HEX \#ff671f), `"berry"` (defined as HEX
\#a6192e) and `"brown"` (defined as HEX \#6b3529).
