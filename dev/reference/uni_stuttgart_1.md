...
`uni_stuttgart_1` provides three primary colors and one secondary color
...
`uni_stuttgart_1` uses the HEX color definitions. CMYK color differs
...
for Stuttgart's primary colors with alternative printing colors for more
contrast; [`seecol`](https://rdrr.io/pkg/unikn/man/seecol.html) for
