...
`uni_regensburg_1` provides the general (administrative and
service-oriented) colors of the [University of
Regensburg](https://www.uni-regensburg.de), Germany.
...
<https://www.uni-regensburg.de/interne-kommunikation/corporate-design/>.
...
Named colors of `uni_regensburg_1` correspond to the following UR
services:

1.  `neutralgrau`: Main color (UR-Hausfarbe, Logo)

2.  `blaugrau`: Leitung, Organe und Verwaltung (LOV, Ausnahme: Referate
    I/3, I/4, I/5, I/6)

3.  `schwarzrot`: Chancengleichheit und Familie (Familien-Service,
    Frauenbeauftragte, Frauenfoerderung, Gleichstellung)

4.  `schilfgruen`: Service-Einrichtungen der Verwaltung für Studierende
    (Akademisches Auslandsamt, Studentenkanzlei, Zentrales
    Pruefungssekretariat, Zentrale Studienberatung, Senatsbeauftragter
...
10. `violettrot`: Zentrum fuer Hochschul- und Wissenschaftsdidaktik
    (ZHW)

11. `gruenbraun`: Regensburger Universitätszentrum fuer Lehrerbildung
    (RUL)
...
for the faculty colors of the University of Regensburg;
...
``` r
uni_regensburg_1
#> neutralgrau    blaugrau  schwarzrot schilfgruen dianthusrot  saphirblau 
#>   "#8E8E8D"   "#1D3F4B"   "#5F002F"   "#3D4100"   "#A46674"   "#032352" 
#>   farngruen    rotbraun perlviolett  violettrot  gruenbraun  wasserblau 
#>   "#416224"   "#724B51"   "#564E6F"   "#3B0041"   "#866800"   "#00817B" 
