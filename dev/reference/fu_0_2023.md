...
`fu_0_2023` provides the two primary colors of the [Free University
...
[Hausfarben](https://www.fu-berlin.de/sites/corporate-design/index.html)
page.
...
The dark `"FU blue"` implies consistency, seriousness, and respect. It
is defined as Pantone 280C and approximated by CMYK 100/72/0/18.5, RGB
0/51/102, and HEX \#003366.

The bright `"FU green"` implies renewal and mobility. It is is defined
as Pantone 381C and approximated by CMYK 18.5/0/91/0, RGB 153/204/0, and
HEX \#99CC00.

See
[`fu_1_2023`](https://hneth.github.io/unicol/dev/reference/fu_1_2023.md)
for a corresponding color gradient.

## See also

[`fu_1`](https://hneth.github.io/unicol/dev/reference/fu_1.md) to
[`fu_4`](https://hneth.github.io/unicol/dev/reference/fu_4.md) for new
colors of the FU Berlin (updated in 2024);
