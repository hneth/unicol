...
`uni_freiburg_0` provides the three basic colors of the [University of
...
<https://uni-freiburg.de/> (at `https://cd.uni-freiburg.de/farben/` on
2023-04-28).
...
The primary color `Blau` (here: `uni_freiburg_0[2]`) is alternatively
defined as `Pantone 7687C`, `RGB 52/74/154`, `HEX #344a9a`, or
`CMYK 90/75/0/0`.

See
[`uni_freiburg_1`](https://hneth.github.io/unicol/dev/reference/uni_freiburg_1.md)
for a primary palette with a `Blau` color gradient and the
