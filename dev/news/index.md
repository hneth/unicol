...
This is the development version of **unicol** available at
...
**unicol** (v0.4.0) was published [on
CRAN](https://CRAN.R-project.org/package=unicol) \[2025-09-02\]:

- This version updates color palettes and improves package maintenance.
...
- Corrected or updated color palettes:
  - [Free University Berlin](https://www.fu-berlin.de/en/index.html)
    ...
    to
    [`fu_3_2023`](https://hneth.github.io/unicol/dev/reference/fu_3_2023.html))

Color palettes are linked to their [online documentation of the current
GitHub development version](https://hneth.github.io/unicol/dev/).

### Details

- Provided package anchors for all Rd `\link{}` targets (to comply with
  [CRAN](https://CRAN.R-project.org/) requirements).

The development version of **unicol** is available at
<https://github.com/hneth/unicol/>.
...
**unicol** (v0.3.0) was published [on
CRAN](https://CRAN.R-project.org/package=unicol). \[2024-05-01\]
...
- New color palettes:
  ...
  - [Martin Luther University
    Halle-Wittenberg](https://www.uni-halle.de) (Germany):
...
- Corrected or updated color palettes:
  - [Columbia University](https://www.columbia.edu) (USA): 3 new color
    palettes
    ...
    [`columbia_3`](https://hneth.github.io/unicol/dev/reference/columbia_3.html))
    replace the former
    [`columbia_v0`](https://hneth.github.io/unicol/dev/reference/columbia_v0.html)
    palette
...
**unicol** (v0.2.0) was published [on
CRAN](https://CRAN.R-project.org/package=unicol). \[2023-09-15\]

This version adds and updates color palettes, but also improves
consistency, simplicity, and fixes some bugs.
...
- New color palettes:
  - [Aberystwyth University](https://aber.ac.uk/en/) (Wales, UK):
    `aberystwyth_1`, `aberystwyth_2`  
  - [Cardiff University](https://www.cardiff.ac.uk) (Wales, UK):
    `cardiff_1`, `cardiff_2`
  - [Macquarie University](https://www.mq.edu.au) (Australia): `mq_1`,
    `mq_2`
  - [Maynooth University](https://www.maynoothuniversity.ie) (Ireland):
    `maynooth`
  - [Ohio University](https://www.ohio.edu) (USA): `ohio_uni_1`,
    `ohio_uni_2`
  - [University College Cork](https://www.ucc.ie/en/) (Ireland):
    `ucc_1`, `ucc_2`
  - [University College Dublin](https://www.ucd.ie) (Ireland): `ucd`
  - [University of Auckland](https://www.auckland.ac.nz/en.html) (New
    Zealand): `auckland_1`, `auckland_2`
  - [University of Groningen](https://www.rug.nl) (Netherlands):
    `groningen_1`, `groningen_2`
  - [University of Lisbon](https://www.ulisboa.pt) (Portugal):
    `uni_lisbon`
  - [University of Otago](https://www.otago.ac.nz) (New Zealand):
    `otago`
  - [University of Nottingham](https://www.nottingham.ac.uk) (England,
    UK): `nottingham_1`, `nottingham_2`, `nottingham_3`
  - [University of Wollongong](https://www.uow.edu.au) (Australia):
...
- Corrected or updated color palettes:
  - [Humboldt University Berlin](https://www.hu-berlin.de) (Germany):
    `hu_1`, `hu_1_digital`, `hu_2`, `hu_3_accent` (previous palettes are
    now `hu_1_2022` and `hu_2_2022`)
  - [Trinity College Dublin](https://www.tcd.ie) (Ireland): `trinity_2`
    has been corrected
  - [UCLA](https://www.ucla.edu) (USA): added `ucla_4` for creating
    color gradients
...
R package **unicol** (v0.1.0) was published [on
CRAN](https://CRAN.R-project.org/package=unicol). \[2023-08-16\]

The **unicol** package initially provides **202 color palettes** from
**86 institutions**.
