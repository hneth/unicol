...
#' Colors of the Brown University
#'
...
#' \code{"red"} (for exact definition check above) and
#' \code{"brown"} (for exact definition check above) .
#'
#' The two accent primary colors are
#' \code{"gold"} (for exact definition check above) and
#' \code{"gray"} (for exact definition check above) .
#'
...
#' \href{https://www.brown.edu/university-identity/sites/university-identity/files/Brown_Visual_Identity_Policy_2016-07-22.pdf}
#' @examples
#' brown_1
...
# # Check: 
# unikn::seecol(brown_1, main = "Primary colors of the Brown University", col_bg = "lightgrey")
...
#' \code{"skyblue"} (for exact definition check above),
#' \code{"emerald"} (for exact definition check above),
#' \code{"navy"} (for exact definition check above), and
#' \code{"taupe"} (for exact definition check above) .
#'
#'
...
#' @examples
#' brown_2
#' unikn::seecol(brown_2, main = "Brown University") # view color palette
#'
#' @family university color palettes
#'
#' @seealso
...
# # Check: 
# unikn::seecol(brown_2, main = "Secondary colors of the Brown University", col_bg = "lightgrey")
